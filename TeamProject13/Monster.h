...
private:
	...
	bool defeated = false;
public:
	Monster(std::string name, int pressure, int atk, int def, int rewardExp, int rewardGold) { this->name = name; this->pressure = pressure; maxPressure = pressure; 
	...
	void MonsterAction(Player& player);
